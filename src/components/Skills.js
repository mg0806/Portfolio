...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      ...
      absolute dark:text-dark dark:bg-light lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transparent xs:dark:bg-transparent xs:text-dark
  ...
  return (
    <>
      ...
      >
        ...
        <Skill name="FIGMA" x="32vw" y="-10vw" />
