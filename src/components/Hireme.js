...
const Hireme = () => {
  return (
    <div className=" absolute left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:-top-16 md:bottom-0 sm:right-0 sm:left-auto sm:-top-32 sm:bottom-16 ">
